...
export const MOCK_FRANCHISES: Franchise[] = [
  ...
  },
  {
    _id: "fr-6",
    code: "FR-HSR",
    name: "Hosur Franchise",
    location: "Hosur, Tamil Nadu",
    state: "Tamil Nadu",
    territoryDistricts: ["Krishnagiri", "Hosur Industrial Complex"],
    pincodes: ["635109", "635126"],
    agreementStartDate: "2023-04-01",
    agreementEndDate: "2026-03-31",
    status: "Active",
    annualTarget: 12000000,
    achievedSales: 9600000,
    collections: 8200000,
    commissionEarned: 768000,
    commissionPaid: 700000,
    contactPerson: "Ravichandran M",
    email: "admin.hsr@arguscnc.com",
  ...
  },
  {
    ...
    state: "Maharashtra",
    territoryDistricts: ["Pune", "Pimpri-Chinchwad", "Chakan"],
    pincodes: ["411018", "411026", "410501"],
    agreementStartDate: "2023-09-01",
    agreementEndDate: "2026-08-31",
    status: "Active",
    annualTarget: 11000000,
    achievedSales: 7200000,
    collections: 6100000,
    commissionEarned: 576000,
    commissionPaid: 520000,
    contactPerson: "Sachin Kulkarni",
    email: "admin.pune@arguscnc.com",
  ...
  },
  {
    ...
    state: "Telangana",
    territoryDistricts: ["Hyderabad", "Rangareddy", "Medchal"],
    pincodes: ["500037", "500072", "500001"],
    agreementStartDate: "2024-02-01",
    agreementEndDate: "2027-01-31",
    status: "Active",
    annualTarget: 13000000,
    achievedSales: 8900000,
    collections: 7400000,
    commissionEarned: 712000,
    commissionPaid: 650000,
    contactPerson: "Venkata Rao",
    email: "admin.hyd@arguscnc.com",
  ...
  },
  {
    ...
    state: "Gujarat",
    territoryDistricts: ["Ahmedabad", "Sanand", "Gandhinagar"],
    pincodes: ["380015", "382110", "382010"],
    agreementStartDate: "2024-03-01",
    agreementEndDate: "2027-02-28",
    status: "Active",
    annualTarget: 14000000,
    achievedSales: 8400000,
    collections: 7100000,
    commissionEarned: 672000,
    commissionPaid: 600000,
    contactPerson: "Jignesh Patel",
    email: "admin.amd@arguscnc.com",
    phone: "+91 98980 12345",
  },
  {
    _id: "fr-10",
    code: "FR-TPR",
    name: "Tiruppur Franchise",
    location: "Tiruppur, Tamil Nadu",
    state: "Tamil Nadu",
    territoryDistricts: ["Tiruppur City", "Avinashi", "Palladam"],
    pincodes: ["641601", "641602", "641654"],
    agreementStartDate: "2023-11-01",
    agreementEndDate: "2026-10-31",
    status: "Active",
    annualTarget: 9500000,
    achievedSales: 6300000,
    collections: 5400000,
    commissionEarned: 504000,
    commissionPaid: 450000,
    contactPerson: "Natarajan S",
    email: "admin.tpr@arguscnc.com",
    phone: "+91 98432 44332",
  },
  {
    _id: "fr-11",
    code: "FR-DEL",
    name: "Delhi NCR Franchise",
    location: "Gurugram, Haryana / Delhi NCR",
    state: "Haryana",
    territoryDistricts: ["Gurugram", "Manesar", "Faridabad"],
    pincodes: ["122001", "122051", "121001"],
    agreementStartDate: "2024-01-15",
    agreementEndDate: "2027-01-14",
    status: "Active",
    annualTarget: 17000000,
    achievedSales: 10200000,
    collections: 8700000,
    commissionEarned: 816000,
    commissionPaid: 750000,
    contactPerson: "Deepak Verma",
    email: "admin.delhi@arguscnc.com",
    phone: "+91 98110 56789",
  },
  {
    _id: "fr-12",
    code: "FR-TRZ",
    name: "Trichy Franchise",
    location: "Tiruchirappalli, Tamil Nadu",
    state: "Tamil Nadu",
    territoryDistricts: ["Tiruchirappalli", "Thanjavur", "Pudukkottai"],
    pincodes: ["620001", "620014", "613001"],
    agreementStartDate: "2024-04-01",
    agreementEndDate: "2027-03-31",
    status: "Active",
    annualTarget: 7500000,
    achievedSales: 4800000,
    collections: 4100000,
    commissionEarned: 384000,
    commissionPaid: 350000,
    contactPerson: "Rajendran A",
    email: "admin.trichy@arguscnc.com",
    phone: "+91 94431 99887",
  },
];
