          ...
          <div className="relative">
            ...
            {showRoleDropdown && (
              <div className="absolute right-0 mt-2 w-72 bg-white text-slate-800 rounded-xl shadow-2xl border border-slate-200 z-50 overflow-hidden animate-fadeIn">
                {isHeadOffice && availableUsers.length > 1 ? (
                  <>
                    <div className="px-3.5 py-2.5 bg-slate-100 border-b border-slate-200 text-xs font-semibold text-slate-600 flex items-center gap-1.5">
                      ...
                      <span>Switch Live Role / Personnel</span>
                    </div>
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="text-xs font-bold text-slate-900 flex items-center justify-between">
                                ...
                                {isSelected && (
                                  <span className="text-[10px] bg-[#FF6600] text-white px-1.5 py-0.2 rounded shrink-0 ml-1">
                                    Active
                                  </span>
                                )}
                              </div>
                              ...
                              <div className="text-[10px] text-[#FF6600] font-medium truncate">
                                {user.franchiseName || organization?.name || currentUser.orgName || "Head Office"}
                              </div>
                            </div>
                          </button>
                        );
                  ...
                  <div className="p-4 bg-slate-50 border-b border-slate-200 text-center">
                    <div className="w-12 h-12 mx-auto rounded-full bg-[#FF6600] text-white flex items-center justify-center font-bold text-base shadow-sm mb-2">
                    ...
                    <div className="mt-1.5 inline-block px-2 py-0.5 rounded text-[11px] font-semibold bg-orange-100 text-[#FF6600]">
                      {currentUser.franchiseName || currentUser.role.replace(/_/g, " ")}
                    </div>
                  </div>
                )}
